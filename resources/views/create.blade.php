...
<form action="store" method="post">
  ...
  <div class="form-outline mb-4">
    <input type="text" name="title" class="form-control" maxlength="100" placeholder="Titulo" required/>
   
  </div>
  <!-- Descrição input -->
  <div class="form-outline mb-4">
      <input type="text" name="description" maxlength="200" class="form-control" placeholder="Descrição" />
  </div>
